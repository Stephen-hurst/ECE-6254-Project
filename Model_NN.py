...
LR = 1e-3
env = gym.make('CartPole-v1') # MsPacman-ram-v0')
env.reset()
goal_steps = 1000
...
training_data=[]
training_data = model_feedback_data()
model = train_model(training_data, model=model)


env = gym.wrappers.Monitor(env, 'C:\\Users\\Emily\\Downloads\\ECE-6254\\Homework\\Class_Project\\', force = True)
model_test()
